...
public class Problema {
	...
	System.out.println("El �rea de la figura es "+areaTotal);
	System.out.println("El per�metro de la figura es "+perimetroTotal);
	
	
	GestorFiguras arrayListFiguras=new GestorFiguras();
	System.out.println("A�adimos las figuras");
